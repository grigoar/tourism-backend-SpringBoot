...
public class CityService {
	...
	public CityDTO findCityById(int cityId) {
		...
		List<ImageModel> cityImages = imageRepository.findAllCityImagesById(city.getId());
		List<ImageDTO> cityImagesDTO = new ArrayList<ImageDTO>();
		for(ImageModel cityImage: cityImages) {
			ImageDTO imageNewDTO = new ImageDTO();
			imageNewDTO.setId(cityImage.getId());
			imageNewDTO.setName(cityImage.getName());
			imageNewDTO.setPic(cityImage.getPic());
			imageNewDTO.setHotel_id(cityImage.getHotel_id());
			imageNewDTO.setRestaurant_id(cityImage.getRestaurant_id());
			imageNewDTO.setEvent_id(cityImage.getEvent_id());
			imageNewDTO.setCity_id(cityImage.getCity_id());
			imageNewDTO.setUser_id(cityImage.getUser_id());
			imageNewDTO.setTouristAttraction_id(cityImage.getTouristAttraction_id());
			cityImagesDTO.add(imageNewDTO);
		}
