...
public class CityDTO {
	...
	private List<ImageDTO> cityImages=new ArrayList<>();
	...
	public CityDTO(Integer id, String name, String country, String description,
			Double lat, Double lon,List<ImageDTO> nestedCityImages) {
		this.id=id;
		this.name=name;
		this.country=country;
		this.description=description;
		this.lat=lat;
		this.lon=lon;
		this.cityImages=nestedCityImages;
	}
	...
	public List<ImageDTO> getCityImages() {
		return cityImages;
	}

	public void setCityImages(List<ImageDTO> cityImages) {
	...
	public static class Builder{
		...
		private List<ImageDTO> nestedCityImages;
...
//		private Set<TouristAttractionDTO>touristAttractions=new HashSet<>();
		...
		public Builder cityImages(List<ImageDTO> cityImages) {
			this.nestedCityImages=cityImages;
			return this;
		}
		public CityDTO create() {
			return new CityDTO(nestedid,nestedname,nestedcountry,nesteddescription, nestedlat, nestedlon,nestedCityImages);
		}
